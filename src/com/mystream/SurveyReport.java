...
public class SurveyReport {
	...
	public int findMaxRequests() {
        int totalConnectionRequest = 0;
		return totalConnectionRequest;
    }

    public double calculateAverageTime() {
        double noOfDaysForRequestCompletion = 0;
		double totalConnectionRequest = 0;
		return (double) noOfDaysForRequestCompletion / totalConnectionRequest;
    }

    public int findTotalAveragePerDay() {
        int averageRequestPerDay = 0;
